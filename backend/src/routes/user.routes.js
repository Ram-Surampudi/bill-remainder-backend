...
import { changeCurrentPassword, changeUsername, deactivateAccount, forgotPasswordRequest, getCurrentUser, getUser, refreshAcessToken, resetForgotPassword } from '../controllers/user.controller.js';
import { changeCurrentPasswordValidator, userForgotPasswordValidator, userResetForgotPasswordValidator } from '../validators/index.js';
